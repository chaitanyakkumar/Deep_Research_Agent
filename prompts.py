clarify_user_prompt = """
These are the messages exchanged so far from the user
...
Check if you have enough information or the user has to provide any more information for you to
start the research process

IMPORTANT : If you see in chat history that you have asked a clarifying questions and the user
answered the question, you almost always do not need to ask another clarifying questions. You
need to ask another questions only if its ABSOLUTELY NECESSARY
...
#prompt for the research supervisor

research_supervisor_prompt = """ You are a research supervisor tasked with conducted research by calling the **Conduct_Research** Tool.
